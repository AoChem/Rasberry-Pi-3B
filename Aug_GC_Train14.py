...
# Delete the evaluation part
# Delete the print("Training...") part
# Revise the Export Model part
...
from Aug_upload_image import upload_image_excel # self_defined

# set up google cloud automl 
print("Setting Up")

project_id = "semesterproject-294707"
display_name = "Test_Dataset14" # dataset name

storage_client = storage.Client()
bucket_name = 'ao-example'
model_name = 'Test_Model14'
remote_model_filename = 'edgetpu_model.tflite' #tflit: TensorFlow Lite
model_filename = 'edgetpu_model14.tflite'
csv_name = 'images14.csv'
...
status_list = ['unassembled', 'assembled']
